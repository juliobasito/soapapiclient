      ...
      <div class="col s12 m6">
        <div class="card">
          <div class="card-content white-text">
            ...
            <h5 class="black-text center-align">5h / 10h</h5>
          </div>
        </div>
      </div>
      <div class="col s12 m6">
        <div class="card">
          <div class="card-content white-text">
            ...
            <h5 class="black-text center-align">30min</h5>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="col s12 m6">
        <div class="card">
          <div class="card-content white-text">
            ...
            <div class="row">
              <h5 class="black-text center-align">Permis de conduire <i class="material-icons">new_releases</i></h5>
            </div>
          </div>
        </div>
      </div>
  ...
  <div class="foot blue">
    <div class="row noMarge">
      <div class="col s6 center-align">
        <a href="" class="white-text"><i class="small material-icons">info</i></a>
      </div>
      <div class="col s6 center-align">
        <a href="" class="white-text"><i class="small material-icons">work</i></a>
      </div>
    </div>
  </div>
